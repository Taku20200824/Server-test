...
This repository is now set up as a Vercel-ready Next.js app inspired by `THE-ISLE`, with a separate Firebase project expected for live site data.
...
4. Copy the Web App config values into Vercel Environment Variables and `.env.local`.
...
Then add the Firebase environment variables in Vercel Project Settings -> Environment Variables and redeploy.
